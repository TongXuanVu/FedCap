...
def get_args_parser(subparsers):
    ...
    # Model parameters
    subparsers.add_argument('--model_name',default='ViT-B/16',type=str, help="model name of ViT")
    subparsers.add_argument('--prompt_template',  default='a photo of a {}',type=str, help="template of prompt")
    ...
    subparsers.add_argument('--jit',default=False,type=bool,help="clip model need jit or not")
